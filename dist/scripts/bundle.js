...
var _blog = require('../tags/blog.tag');

var _blog2 = _interopRequireDefault(_blog);

var _blogEditor = require('../tags/blog-editor.tag');

var _blogEditor2 = _interopRequireDefault(_blogEditor);

var _post = require('../tags/post.tag');
...
exports.default = {
	...
	init: function init() {
		_riot2.default.mount('blog', { posts: this.loadPosts() });
	},
	loadPosts: function loadPosts() {
		this.posts = _tempdata2.default.posts;
		return this.posts;
	}
};

},{"../tags/blog-editor.tag":5,"../tags/blog.tag":6,"../tags/post.tag":7,"./tempdata":4,"riot":1}],3:[function(require,module,exports){
'use strict';
...
var app = Object.create(_app2.default);
...
module.exports = riot.tag2('blog-editor', '<textarea></textarea>', '', '', function(opts) {
});
},{"riot":1}],6:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('blog', '<h1 class="main-header">Riot blog</h1> <post each="{posts}">', 'blog,[riot-tag="blog"] { display: block; margin: 0 auto; padding: 15px; height: 100%; width: 600px; background-color: #eee; } blog .main-header,[riot-tag="blog"] .main-header { margin-top: 0; }', '', function(opts) {
		this.posts = opts.posts;
}, '{ }');
},{"riot":1}],7:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('post', '<h3>{header}</h3> <div class="post-meta"></div> <div class="post-content">{content}</div> <div class="post-actions"></div>', '', '', function(opts) {
